...
public class PaddingConverter extends LayoutConverter {
    ...
    public List<LayoutAttribute> onFinish() {
        ...
        if (padding[0] != null || padding[1] != null || padding[2] != null || padding[3] != null) {
            ...
            finished.add(new LayoutAttribute(LayoutAttribute.Type.LAYOUT, setter("Padding", padding[0] + "," + padding[1] + "," + padding[2] + "," + padding[3], false)));
        }
        if (paddingRelative[0] != null || paddingRelative[1] != null) {
            ...
            finished.add(new LayoutAttribute(LayoutAttribute.Type.LAYOUT, setter("PaddingRelative", paddingRelative[0] + "," + padding[1] + "," + padding[2] + "," + paddingRelative[1], false)));
        }
        return finished;
    }
}
